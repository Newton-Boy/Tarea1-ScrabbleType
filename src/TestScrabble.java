...
class TestScrabble {
    ...
    @Test public void visitAddTest(){
        Add V1= new Add();
        bType.accept(V1,biType);
        AddScrabble Null=V1.getResult();
        assertEquals(null,Null);

        sType.accept(V1,biType);
        StringScrabble Expected1=new StringScrabble("Hola00000010");
        AddScrabble concatena=V1.getResult();
        assertEquals(Expected1,concatena);

        iType.accept(V1,fType);
        IntScrabble Expected2=new IntScrabble(25);
        AddScrabble SumaIF= V1.getResult();
        assertEquals(Expected2,SumaIF);
        assertNotEquals(SumaIF,concatena);

        biType.accept(V1,iType);
        BinaryScrabble Expected3=new BinaryScrabble("00011001");
        AddScrabble SumaBII= V1.getResult();
        assertEquals(Expected3,SumaBII);
    }
    @Test public void visitSubTest(){
        Sub V2= new Sub();
