...
/**
 * Operador visitante Substracción. Realiza una resta entre Scrabble retornando un
 * resultado adecuado en cada situación (Usando el cuadro 2 como referente)
 */
public class Sub extends visitOperador {
    ...
    public void visitBinaryScrabble(BinaryScrabble Sc1, IntBinaryScrabble Sc2){
        ...
        Sc=FScF.getScrabble(Sc1.Resta(Sc2).getBinary());
    }
